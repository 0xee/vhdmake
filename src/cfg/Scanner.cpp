...
void Scanner::Init() {
	...
	start.set(43, 2);
	start.set(58, 9);
	for (i = 35; i <= 35; ++i) start.set(i, 5);
	for (i = 38; i <= 38; ++i) start.set(i, 5);
	for (i = 40; i <= 42; ++i) start.set(i, 5);
	for (i = 44; i <= 44; ++i) start.set(i, 5);
	for (i = 60; i <= 60; ++i) start.set(i, 5);
	for (i = 62; i <= 62; ++i) start.set(i, 5);
	for (i = 91; i <= 93; ++i) start.set(i, 5);
	for (i = 124; i <= 124; ++i) start.set(i, 5);
	start.set(61, 7);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 7:
			case_7:
			if (ch <= 9 || (ch >= 11 && ch <= 65535)) {AddCh(); goto case_7;}
			else if (ch == 10) {AddCh(); goto case_8;}
			else {goto case_0;}
		case 8:
			case_8:
			{t->kind = 8; break;}
